...
(function (R, B) {
    ...
    var qa = aa + "Delay", Aa = aa + "Duration", ma = S + "Delay", La = S + "Duration", Ma = B.$$minErr("ng"), Ua = {
    ...
    B.module("ngAnimate", [], function () {
        ...
        this.$get = ["$$rAF", "$rootScope", "$rootElement", "$document", "$$HashMap", "$$animation", "$$AnimateRunner", "$templateRequest", "$$jqLite", "$$forceReflow", function (b, c, g, l, C, Wa, Q, t, H, T) {
            ...
            function p(a, h, v) {
                ...
                if (H) {
                    ...
                    if (d("cancel", a, w, v))if (2 === v.state)v.runner.end(); else if (v.structural)v.close(); else return W(a, v, w), v.runner;
        ...
        this.$get = ["$window", "$$jqLite", "$$AnimateRunner", "$timeout", "$$forceReflow", "$sniffer", "$$rAFScheduler", "$$animateQueue", function (a, e, l, n, I, g, u, C) {
            ...
            function Q(r, p, g, n) {
                var k;
                0 < b.count(g) && (k = c.get(g), k || (p = Z(p, "-stagger"), e.addClass(r, p), k = Ha(a, r, n), k.animationDuration =
            ...
            return function (a, c) {
                ...
                ja && f.structural ? $ = Z(ja, "ng-", !0) : ja && ($ = ja);
                ...
                var ba = X ? 0 <= f.staggerIndex ? f.staggerIndex : b.count(ia) :
                    0;
        ...
        this.$get = ["$animateCss", "$rootScope", "$$AnimateRunner", "$rootElement", "$sniffer", "$$jqLite", "$document", function (a, c, d, e, l, n, I) {
            ...
            function C(c, e, n) {
                ...
                var C =
                    F(y(e).cloneNode(!0)), k = g(C.attr("class") || "");
        ...
        this.$get = ["$injector", "$$AnimateRunner", "$$jqLite", function (b, c, d) {
            ...
            return function (a, b, d, u) {
                ...
                function t(a, b, d, e, f) {
                    ...
                    if (0 === g.length) {
                        var h, k;
                        "beforeSetClass" === f ? (h = y(a, "removeClass", d, e, "beforeRemoveClass"), k = y(a, "addClass", d, e, "beforeAddClass")) : "setClass" === f && (h = y(a, "removeClass", d, e, "removeClass"), k = y(a, "addClass",
                            d, e, "addClass"));
                        h && (g = g.concat(h));
                        k && (g = g.concat(k))
                    }
