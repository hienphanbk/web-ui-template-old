...
!function (e, t, n) {
    ...
    !function () {
        ...
        function e(e, n, o) {
            ...
            var d = e.vendorPrefix, s = /webkit/i.test(d), c = /([:\-_]+(.))/g, l = document.createElement("div"), m = {
        ...
        function o(o, r, a, d, s, c, l, m, u, p) {
            ...
            var v = c.startSymbol(), E = c.endSymbol(), $ = "{{" === v && "}}" === E, C = function (e, n, o) {
                var i = !1;
                if (e && e.length) {
                ...
                dom: {}, now: e.performance ? t.bind(e.performance, e.performance.now) : Date.now || function () {
                    ...
                    var i = o.getBoundingClientRect(), r = n ? t.getBoundingClientRect() : {
                        left: 0,
                        top: 0,
                        width: 0,
                        height: 0
                    ...
                    function a() {
                        var e = s.parentNode, t = e.style.cssText || "", n = s.style.cssText || "", o = y.scrollTop(s), i = s.clientWidth;
                    ...
                    var n;
                    return function () {
                        var o = this, i = arguments, r = y.now();
                    ...
                    var i = y.nextTick, a = i.timeout, s = i.queue || [];
                    return s.push({
                        scope: n,
                        callback: e
                    ...
                    var n = y.getClosest(e, "form"), o = n ? t.element(n).controller("form") : null;
                    ...
                    var r = e.scrollTop, a = t - r, d = r < t, s = y.now();
                    p(n)
                }
            };
        ...
        function n(e, n, o, i) {
            ...
            function d(e, t) {
                var n = c(e) || "", o = n.indexOf(i.startSymbol()) > -1;
                o ? a(e, t, function () {
                    return c(e)
                }) : r(e, t, n)
            }
        ...
        function e(e, n, o, i, r) {
            this.compile = function (a) {
                var d = a.templateUrl, s = a.template || "", c = a.controller, l = a.controllerAs, m = t.extend({}, a.resolve || {}), u = t.extend({}, a.locals || {}), p = a.transformTemplate || t.identity, h = a.bindToController;
        ...
        function o(n, o, i) {
            ...
            var m = navigator.userAgent || navigator.vendor || e.opera, u = m.match(/ipad|iphone|ipod/i), p = m.match(/android/i), g = c(), b = "undefined" != typeof e.jQuery && t.element === e.jQuery, v = {
                handler: s,
                register: a,
                isIos: u,
                isAndroid: p,
            ...
            if (v.isHijackingClicks) {
                ...
                v.handler("click", {
                    ...
                    options: {maxDistance: E}, onEnd: function (e, t) {
                        function n(e) {
        ...
        function e() {
            function e(e) {
                ...
                function r(n, o) {
                    ...
                    var c, l, m = n(), u = {hide: m.hide, cancel: m.cancel, show: i, destroy: r};
                    return c = s.methods || [], l = a(s.optionsFactory, {}), t.forEach(d, function (e, t) {
                        ...
                        var i = a(e.optionsFactory, {}), r = (e.methods || []).concat(c);
                ...
                var a = ["onHide", "onShow", "onRemove"], d = {}, s = {presets: {}}, c = {
                    setDefaults: n,
                    addPreset: i,
                    addMethod: o,
                    $get: r
                };
                return c.addPreset("build", {methods: ["controller", "controllerAs", "resolve", "template", "templateUrl", "themable", "transformTemplate", "parent"]}), r.$inject = ["$$interimElement", "$injector"], c
            }
            ...
            function o(e, o, i, r, a, d, s, c, l, m, u) {
                return function () {
                    ...
                    function b(u) {
                        ...
                        var M, T, A = o.when(!0);
                        return u = f(u), M = {options: u, deferred: o.defer(), show: p, remove: h}
                    }
        ...
        e.$inject = ["$mdButtonInkRipple", "$mdCheckboxInkRipple"], o.$inject = ["$scope", "$element", "rippleOptions", "$window", "$timeout", "$mdUtil", "$mdColorUtil"], o.prototype.color = function (e) {
            ...
            if (this.isRippleAllowed()) {
                var i = this, r = i.$mdColorUtil, d = t.element('<div class="md-ripple"></div>'), s = this.$element.prop("clientWidth"), c = this.$element.prop("clientHeight"), l = 2 * Math.max(Math.abs(s - e), e), m = 2 * Math.max(Math.abs(c - n), n), u = o(this.options.fitRipple, l, m), p = this.calculateColor();
                d.css({
                    left: e + "px",
                    top: n + "px",
                    background: "black",
        ...
        !function (e) {
            ...
            function o(t) {
                ...
                function a(t, n) {
                    if (h[t])return h[t];
                    n = n || "default";
                    var o = "string" == typeof n ? h[n] : n, i = new s(t);
                ...
                function l(t, o) {
                    ...
                    function r(n, r) {
                        ...
                        var c = r.controller("mdTheme"), l = n.attr("md-theme-watch"), m = (E || e.isDefined(l)) && "false" != l;
                ...
                return e.extend(p, t), l.$inject = ["$rootScope", "$log"], m = {
                    ...
                    configuration: function () {
                        var t = {defaultTheme: $, alwaysWatchTheme: E};
            ...
            function d(t, n, o) {
                ...
                var i = [], r = t.colors[n], a = new RegExp("\\.md-" + t.name + "-theme", "g"), d = new RegExp("('|\")?{{\\s*(" + n + ")-(color|contrast)-?(\\d\\.?\\d*)?\\s*}}(\"|')?", "g"), s = /'?"?\{\{\s*([a-zA-Z]+)-(A?\d+|hue\-[0-3]|shadow|default)-?(\d\.?\d*)?(contrast)?\s*\}\}'?"?/g, c = p[r.name];
        ...
        function n(n, o, i, r, a) {
            ...
            return d = {
                translate3d: function (e, t, n, o) {
                    ...
                    if (o || i) {
                        var r = o ? d.clientRect(o) || n() : d.copyRect(i), a = d.copyRect(e[0].getBoundingClientRect()), s = d.centerPointFor(a), c = d.centerPointFor(r);
                        return {
                            centerX: c.x - s.x,
                            centerY: c.y - s.y,
        ...
        t.version.minor >= 4 ? t.module("material.core.animate", []) : !function () {
            ...
            t.module("material.core.animate", []).factory("$$forceReflow", d).factory("$$AnimateRunner", c).factory("$$rAFMutex", s).factory("$animateCss", ["$window", "$$rAF", "$$AnimateRunner", "$$forceReflow", "$$jqLite", "$timeout", "$animate", function (t, d, s, c, l, m, u) {
                function p(o, d) {
                    var c = [], l = C(o), p = l && u.enabled(), g = !1, M = !1;
                ...
                function f(e) {
                    ...
                    var i = C(e), r = t.getComputedStyle(i), a = g(r[n("transitionDuration")]), d = g(r[n("animationDuration")]), s = g(r[n("transitionDelay")]), c = g(r[n("animationDelay")]);
                    d *= parseInt(r[n("animationIterationCount")], 10) || 1;
                    var l = Math.max(d, a), m = Math.max(c, s);
                    return {
                        duration: l,
                        delay: m,
                        animationDuration: d,
        ...
        function n(e) {
            function n(e, n, r, a, d, s, c, l) {
                ...
                function p(e, t) {
                    ...
                    var m = c.register(t, "drag", {horizontal: !1});
        ...
        !function () {
            function e(e, n, o) {
                ...
                function s(e) {
                    ...
                    return t.forEach(e, function (e, t) {
                        var i = l(e), r = t.indexOf("background") > -1;
                ...
                function m(t, o) {
                    var i = t.length > 1 && r.indexOf(t[1]) !== -1, a = t[0].replace(/([a-z])([A-Z])/g, "$1-$2").toLowerCase();
                ...
                return r = r || Object.keys(e.PALETTES), {applyThemeColors: i, getThemeColor: a, hasTheme: c}
            }
            ...
            function o(e, n, o, r) {
                return {
                    restrict: "A", require: ["^?mdTheme"], compile: function (a, d) {
                        function s() {
                            var e = d.mdColors, o = e.indexOf("::") > -1, r = !!o || i.test(d.mdColors);
            ...
            var i = /^{((\s|,)*?["'a-zA-Z-]+?\s*?:\s*?('|")[a-zA-Z0-9-.]*('|"))+\s*}$/, r = n;
        ...
        function o(e) {
            ...
            function i(e, o, i, d, s, c, l, m, u, p, h) {
                ...
                function C(n, o) {
                    var r = t.element(l), a = i.debounce(function () {
                        A(n, o)
                    }, 60), s = [], c = function () {
                ...
                function M(e, t) {
                    var n = "alert" === t.$type ? "alertdialog" : "dialog", d = e.find("md-dialog-content"), s = e.attr("id"), c = "dialogContent_" + (s || i.nextUid());
                    e.attr({
                        role: n,
                        tabIndex: "-1"
                ...
                function A(e, t) {
                    var n = "fixed" == l.getComputedStyle(c[0].body).position, o = t.backdrop ? l.getComputedStyle(t.backdrop[0]) : null, r = o ? Math.min(c[0].body.clientHeight, Math.ceil(Math.abs(parseInt(o.height, 10)))) : 0, a = {
                        top: e.css("top"),
                        height: e.css("height")
                    };
                    return e.css({
        ...
        !function () {
            ...
            function o() {
                function n(n, o, i) {
                    if (o) {
                        var r = n[0], a = n.controller("mdFabToolbar"), d = r.querySelector(".md-fab-toolbar-background"), s = r.querySelector("md-fab-trigger button"), c = r.querySelector("md-toolbar"), l = r.querySelector("md-fab-trigger button md-icon"), m = n.find("md-fab-actions").children();
                        if (s && d) {
        ...
        function e(e, o, i, r) {
            function a(n, a, d, s) {
                ...
                function h(e, t, n, o, i, r, a) {
                    var d = 1 / n * 100, s = (n - 1) / n, c = _({
                        share: d,
                        gutterShare: s,
                        gutter: i
                    }), l = {
                        left: x({unit: c, offset: e.col, gutter: i}),
                        width: S({unit: c, span: t.col, gutter: i}),
                        paddingTop: "",
                        marginTop: "",
                        top: "",
                        height: ""
                    ...
                    switch (r) {
                        case"fixed":
                            l.top = x({unit: a, offset: e.row, gutter: i}), l.height = S({
                                unit: a,
                                span: t.row,
                                gutter: i
                            });
                            break;
                        case"ratio":
                            var m = d / a, u = _({share: m, gutterShare: s, gutter: i});
                            l.paddingTop = S({unit: u, span: t.row, gutter: i}), l.marginTop = x({
                                unit: u,
                                offset: e.row,
                                gutter: i
                            });
                            break;
                        case"fit":
                            var p = (o - 1) / o, m = 1 / o * 100, u = _({share: m, gutterShare: p, gutter: i});
                            l.top = x({unit: u, offset: e.row, gutter: i}), l.height = S({
                                unit: u,
                                span: t.row,
                                gutter: i
                            })
                ...
                function f(e, t, n, o, i) {
                    ...
                    switch (o) {
                        case"fixed":
                            ...
                            break;
                        case"ratio":
                            var a = 1 === e ? 0 : (e - 1) / e, d = 1 / e * 100, s = d * (1 / i), c = _({
                                share: s,
                                gutterShare: a,
                                gutter: n
                            });
                            r.height = "", r.paddingBottom = S({unit: c, span: t, gutter: n});
                            break;
                        case"fit":
                    }
                    return r
                ...
                var M = t.bind(s, s.invalidateLayout), T = c();
                n.$on("$destroy", l);
        ...
        function n(e, t) {
            function n(t, n) {
                e(n);
                var o = n[0].querySelector(r), i = n[0].querySelector(a);
        ...
        function i(e, n, o, i, r) {
            function a(a, d, s, c) {
                ...
                function p() {
                    ...
                    function u() {
                        ...
                        if (!s.hasOwnProperty("mdNoResize")) {
                            var l = t.element('<div class="md-resize-handle"></div>'), u = !1, p = null, f = 0, g = h.element, b = r.register(l, "drag", {horizontal: !1});
                ...
                var h = c[0], f = !!c[1], g = c[1] || e.fakeNgModel(), b = c[2], v = t.isDefined(s.readonly), E = e.parseAttributeBoolean(s.mdNoAsterisk), $ = d[0].tagName.toLowerCase();
                if (h) {
        ...
        function n(e, n, o, i) {
            ...
            return {
                restrict: "E", controller: "MdListController", compile: function (a, d) {
                    ...
                    if (a[0].setAttribute("role", "listitem"), d.ngClick || d.ngDblclick || d.ngHref || d.href || d.uiSref || d.ngAttrUiSref)l("button"); else {
        ...
        var d = 80, s = "_md-panel-hidden", c = t.element('<div class="_md-panel-focus-trap" tabindex="0"></div>');
        e.$inject = ["$rootElement", "$rootScope", "$injector", "$window"], e.prototype.create = function (e) {
            ...
            var i = "panel_" + this._$injector.get("$mdUtil").nextUid(), r = t.extend({id: i}, this._config);
            ...
            var n = e[0].getBoundingClientRect(), o = n.width, r = n.height, a = this._relativeToEl[0].getBoundingClientRect(), d = a.left, s = a.right, c = a.width;
        ...
        function e(e, n, o) {
            ...
            var d = "determinate", s = "indeterminate", c = "buffer", l = "query", m = "_md-progress-linear-disabled";
            return {
                restrict: "E",
        ...
        function o(e, o, i, r, a, d, s) {
            function c(d, c) {
                ...
                if (l.append('<span class="md-select-icon" aria-hidden="true"></span>'), l.addClass("md-select-value"), l[0].hasAttribute("id") || l.attr("id", "select_value_label_" + o.nextUid()), d.find("md-content").length || d.append(t.element("<md-content>").append(d.contents())), c.mdOnOpen && (d.find("md-content").prepend(t.element('<div> <md-progress-circular md-mode="indeterminate" ng-if="$$loadingAsyncDone === false" md-diameter="25px"></md-progress-circular></div>')), d.find("md-option").attr("ng-show", "$$loadingAsyncDone")), c.name) {
                    ...
                    m.attr({name: c.name, "aria-hidden": "true", tabindex: "-1"});
                ...
                var p = o.parseAttributeBoolean(c.multiple), h = p ? "multiple" : "", f = '<div class="md-select-menu-container" aria-hidden="true"><md-select-menu {0}>{1}</md-select-menu></div>';
                return f = o.supplant(f, [h, d.html()]), d.empty().append(l), d.append(f), c.tabindex || c.$set("tabindex", 0), function (d, c, l, m) {
                    function u() {
                    ...
                    A.$render = function () {
                        ...
                        if (T.setIsPlaceholder(!e), l.mdSelectedText)e = s(l.mdSelectedText)(d); else {
                    ...
                    l.$observe("ngMultiple", function (e) {
                        ...
                        t.isString(e) && (e = !0), $ !== n && $ === e || ($ = e, e ? c.attr({"aria-disabled": "true"}).removeAttr("tabindex").off("click", E).off("keydown", v) : c.attr({
                            tabindex: l.tabindex,
                            "aria-disabled": "false"
                        }).on("click", E).on("keydown", v))
                    }), l.hasOwnProperty("disabled") || l.hasOwnProperty("ngDisabled") || (c.attr({"aria-disabled": "false"}), c.on("click", E), c.on("keydown", v));
                    var R = {
                        role: "listbox",
                        "aria-expanded": "false",
            ...
            function a(e, n, i, a) {
                ...
                function s(n) {
                    ...
                    if (i && r) {
                        ...
                        var a = c.hashGetter(r.value), d = t.isDefined(c.selected[a]);
                        e.$apply(function () {
        ...
        function r(e, n) {
            ...
            function r(o, i, r, a) {
                function d(e, t, n) {
                    ...
                    var i = l.hashGetter(t, o), r = l.hashGetter(e, o);
        ...
        function s(o) {
            function i(o, i, l, m, u, p, h, f, g) {
                    ...
                    function s() {
                        return u(function (t) {
                            ...
                            n.container.element.css(y.toCss(n.container.styles)), n.dropDown.element.css(y.toCss(n.dropDown.styles)), p(function () {
                                r.addClass("md-active"), n.dropDown.element.css(y.toCss({transform: ""})), b(a.focusedNode), t()
                            })
                        })
                    }

                    function c(e, t, n) {
                        return n.disableParentScroll && !l.getClosest(n.target, "MD-DIALOG") ? n.restoreScroll = l.disableScrollAround(n.element, n.parent) : n.disableParentScroll = !1, n.hasBackdrop && (n.backdrop = l.createBackdrop(e, "md-select-backdrop md-click-catcher"), f.enter(n.backdrop, g[0].body, null, {duration: 0})), function () {
                ...
                var C = "$mdSelect.show() expected a target element in options.target but got '{0}'!", y = l.dom.animator, M = i.KEY_CODE;
        ...
        var c = 8, l = 0, m = t.element('<div class="md-container"><div class="md-icon"></div></div>');
                ...
                return {
                    restrict: "A", multiElement: !0, link: function (i, r, a) {
                        var d = i.$on("$md-resize-enable", function () {
                            d();
                            var s = r[0], c = s.nodeType === o.Node.ELEMENT_NODE ? o.getComputedStyle(s) : {};
                            i.$watch(a[e], function (e) {
                                if (!!e === t) {
                                    n.nextTick(function () {
                                        i.$broadcast("$md-resize")
                                    });
                                    var o = {cachedTransitionStyles: c};
        ...
        function e(e, o, i, r) {
            ...
            var c = "SideNav '{0}' is not available! Did you use md-component-id='{0}'?", l = {find: d, waitFor: s};
            return function (e, n) {
                if (t.isUndefined(e))return l;
                var o = n === !0, i = l.find(e, o);
        ...
        function o(e, n, o, i, r, a, d, s, c, l) {
            ...
            function u(o, m, u, p) {
                ...
                }), K = t.element(m[0].querySelector(".md-thumb")), G = t.element(m[0].querySelector(".md-thumb-text")), X = K.parent(), Q = t.element(m[0].querySelector(".md-track-container")), Z = t.element(m[0].querySelector(".md-track-fill")), J = t.element(m[0].querySelector(".md-track-ticks")), ee = t.element(m[0].getElementsByClassName("md-slider-wrapper")), te = (t.element(m[0].getElementsByClassName("md-slider-content")), i.throttle(y, 5e3)), ne = 3, oe = t.isDefined(u.mdVertical), ie = t.isDefined(u.mdDiscrete), re = t.isDefined(u.mdInvert);
        ...
        function e(e, t, o, i) {
            ...
            return function (e, t, n) {
                ...
                if (o)if (d)t.css({position: d, top: 0, "z-index": 2}); else {
                    ...
                    var s = n || i(t.clone())(e), c = a.add(t, s);
                    e.$on("$destroy", c)
                }
            }
        }
            ...
            function m(d, c, m) {
                ...
                function $() {
                    if (c[0] && "MutationObserver"in n) {
                        ...
                        e.observe(c[0], {attributes: !0}), m.hasOwnProperty("mdVisible") && (d.visibleWatcher = d.$watch("visible", E))
                ...
                function C(e) {
                    if ((e || !x.attr("aria-label")) && !x.text().trim()) {
                        var t = e || c.text().trim(), n = l(t)(x.scope());
                        x.attr("aria-label", n)
                    }
                }
                ...
                function _() {
                    ...
                    var n = r.offsetRect(c, N), o = r.offsetRect(x, N), i = t(d.direction), a = c.prop("offsetParent");
                ...
                a(c);
                var x = r.getParentWithPointerEvents(c), S = t.element(c[0].getElementsByClassName("md-content")[0]), N = t.element(document.body), D = null, H = o.throttle(function () {
                    k()
                });
        ...
        function o(e, n, o, i, r, a, d, s) {
            ...
            e(t.bind(this, function () {
                c();
                var e = n.debounce(c, 10, null, !1), o = t.element(r);
        ...
        function e(e, o, d, s, c, l, m, u, p, h, f) {
            ...
            function v() {
                ...
                function n() {
                    var e = $e.scrollContainer.getBoundingClientRect(), t = {};
            ...
            function ae() {
                ...
                t.initCustomEvent("change", !0, !0, {value: ""}), $e.input.dispatchEvent(t), $e.input.blur(), e.searchText = "", $e.input.focus()
            }
            ...
            function de(n) {
                ...
                var r = e.$parent.$eval(Ee), a = n.toLowerCase(), s = t.isArray(r), c = !!r.then;
                s ? i(r) : c && o(r)
            }
            ...
            function le() {
                if ($e.li[0]) {
                    var e = $e.li[0].offsetHeight, t = e * be.index, n = t + e, o = $e.scroller.clientHeight, i = $e.scroller.scrollTop;
            ...
            function ge() {
                var t = e.searchText, n = be.matches, o = n[0];
            ...
            var be = this, ve = e.itemsExpr.split(/ in /i), Ee = ve[1], $e = null, Ce = {}, ye = !1, Me = [], Te = !1, Ae = 0, we = 0, ke = null, _e = null;
        ...
        function e(e) {
            return {
                ...
                template: function (t, n) {
                    ...
                    var a = i(), d = o(), s = t.html(), c = n.tabindex;
        ...
        function e(e, t) {
            function n(e, n, o) {
                return function (e, n, i) {
                    ...
                    var d = e.$mdAutocompleteCtrl, s = d.parent.$new(), c = d.itemName;
        ...
        function e(e, n, o) {
            function i(i, r) {
                var d = null, s = null, c = o.mdHighlightFlags || "", l = e.$watch(function (e) {
                    return {term: i(e), unsafeText: r(e)}
                }, function (e, o) {
        ...
        function e(e, t, a, d, s, c) {
            function l(n, o) {
                ...
                var l = i("md-chips>md-chip-template"), m = t.prefixer().buildList("md-chip-remove").map(function (e) {
                    return "md-chips>*[" + e + "]"
                }).join(","), p = i(m) || u.remove, h = l || u["default"], f = i("md-chips>md-autocomplete") || i("md-chips>input") || u.input, g = r.find("md-chip");
        ...
        !function () {
            ...
            n.$inject = ["$element", "$scope", "$animate", "$q", "$$mdDateUtil", "$mdDateLocale"], n.prototype.initialize = function (e) {
                var t = e.minDate, n = e.maxDate;
                if (this.calendarCtrl = e, this.items = {length: 2e3}, n && t) {
                    var o = this.dateUtil.getMonthDistance(t, n) + 1;
                    o = Math.max(o, 1), o += 1, this.items.length = o
                }
                if (this.firstRenderableDate = this.dateUtil.incrementMonths(e.today, -this.items.length / 2), t && t > this.firstRenderableDate)this.firstRenderableDate = t; else if (n) {
                    this.items.length - 2;
        ...
        !function () {
            ...
            t.module("material.components.datepicker").directive("mdCalendarMonthBody", e), e.$inject = ["$compile", "$$mdSvgRegistry"], n.$inject = ["$element", "$$mdDateUtil", "$mdDateLocale"], n.prototype.generateContent = function () {
                ...
                r.appendChild(d);
                var s = this.offset === this.monthCtrl.items.length - 1, c = 0, l = document.createElement("td"), m = document.createElement("span");
        ...
        !function () {
            ...
            n.$inject = ["$element", "$scope", "$animate", "$q", "$$mdDateUtil"], n.prototype.initialize = function (e) {
                var t = e.minDate, n = e.maxDate;
                if (this.calendarCtrl = e, this.items = {length: 400}, this.firstRenderableDate = this.dateUtil.incrementYears(e.today, -(this.items.length / 2)), t && t > this.firstRenderableDate ? this.firstRenderableDate = t : n && (this.firstRenderableDate = this.dateUtil.incrementMonths(n, -(this.items.length - 1))), n && t) {
                ...
                if ("select" === t)this.changeDate(o).then(function () {
                    ...
                    if (i) {
                        var a = n.minDate ? r.incrementMonths(r.getFirstDateOfMonth(n.minDate), 1) : null, d = n.maxDate ? r.getFirstDateOfMonth(n.maxDate) : null;
        ...
        !function () {
            t.module("material.components.datepicker").config(["$provide", function (e) {
                ...
                t.prototype.$get = function (e, t) {
                    ...
                    var u = "Calendar", p = "Open calendar", h = {
        ...
        !function () {
            function n(e, n, i) {
                return {
                    template: function (t, n) {
                        var o = n.mdHideIcons, i = "all" === o || "calendar" === o ? "" : '<md-button class="md-datepicker-button md-icon-button" type="button" tabindex="-1" aria-hidden="true" ng-click="ctrl.openCalendarPane($event)"><md-icon class="md-datepicker-calendar-icon" aria-label="md-calendar" md-svg-src="' + e.mdCalendar + '"></md-icon></md-button>', r = "all" === o || "triangle" === o ? "" : '<md-button type="button" md-no-ink class="md-datepicker-triangle-button md-icon-button" ng-click="ctrl.openCalendarPane($event)" aria-label="{{::ctrl.dateLocale.msgOpenCalendar}}"><div class="md-datepicker-expand-triangle"></div></md-button>';
                    ...
                    link: function (e, o, r, a) {
                        var c = a[0], l = a[1], m = a[2], u = a[3], p = n.parseAttributeBoolean(r.mdNoAsterisk);
            ...
            var i = 3, r = "md-datepicker-invalid", a = "md-datepicker-open", d = "_md-datepicker-floating-label", s = "_md-datepicker-has-calendar-icon", c = 500, l = 368, m = 360;
            o.$inject = ["$scope", "$element", "$attrs", "$window", "$mdConstant", "$mdTheming", "$mdUtil", "$mdDateLocale", "$$mdDateUtil", "$$rAF", "$mdGesture"], o.prototype.configureNgModel = function (e, n) {
                ...
                var o = this.inputContainer.getBoundingClientRect(), i = n.getBoundingClientRect(), r = o.top - i.top, d = o.left - i.left, s = i.top < 0 && 0 == document.body.scrollTop ? -i.top : document.body.scrollTop, c = i.left < 0 && 0 == document.body.scrollLeft ? -i.left : document.body.scrollLeft, u = s + this.$window.innerHeight, p = c + this.$window.innerWidth;
                if (d + m > p) {
                    if (p - m > 0)d = p - m; else {
                        d = c;
        ...
        function e(e, t, n, o) {
            function i(o, i, r) {
                ...
                t(i);
                var c = r.mdFontIcon, l = e.fontSet(r.mdFontSet);
        ...
        function i(n, o, i, r, a, d) {
            ...
            function h(n) {
                function a(n) {
                    var o = y.exec(n), r = /base64/i.test(n), a = r ? e.atob(o[2]) : o[2];
            ...
            var E = {}, $ = {}, C = /[-\w@:%\+.~#?&\/\/=]{2,}\.[a-z]{2,4}\b(\/[-\w@:%\+.~#?&\/\/=]*)?/i, y = /^data:image\/svg\+xml[\s*;\w\-\=]*?(base64)?,(.*)$/i;
            return g.prototype = {clone: v, prepare: b}, s.fontSet = c, s
        }
        ...
        function e(e) {
            ...
            function i(e, o, i, r) {
                var a = r[0], d = r[1] != n, s = t.element('<div class="_md md-open-menu-container md-whiteframe-z2"></div>'), c = o.children()[1];
            ...
            function o(e, o, a, d, s, c, l, m, u) {
                ...
                function E(t, o) {
                    ...
                    var c, l = t[0], m = t[0].firstElementChild, u = m.getBoundingClientRect(), p = d[0].body, h = p.getBoundingClientRect(), f = s.getComputedStyle(m), g = o.target[0].querySelector($.buildSelector("md-menu-origin")) || o.target[0], b = g.getBoundingClientRect(), v = {
                        ...
                        right: h.right - r
                    }, E = {top: 0, left: 0, right: 0, bottom: 0}, C = {
                        top: 0,
                        left: 0,
                        right: 0,
                        bottom: 0
                    ...
                    var _ = Math.round(100 * Math.min(b.width / l.offsetWidth, 1)) / 100, x = Math.round(100 * Math.min(b.height / l.offsetHeight, 1)) / 100;
                    return {
        ...
        t.module("material.components.menuBar").controller("MenuItemController", e), e.$inject = ["$scope", "$element", "$attrs"], e.prototype.init = function (e) {
            ...
            var s = this.iconEl, c = t.element(this.buttonEl), l = this.handleClick;
        ...
        function e(e) {
            return {
                ...
                compile: function (n, o) {
                    ...
                    var a = o.type, d = "md-in-menu-bar";
                    if ("checkbox" != a && "radio" != a || !n.hasClass(d))i("role", "menuitem", n[0].querySelector("md-button, button, a")); else {
                        var s = n[0].textContent, c = t.element('<md-button type="button"></md-button>');
        ...
        function e(e, n, o, i, r, a) {
            function d(a, d, c) {
                function f(t, o, r, d, c) {
                    var l = ++N, h = i.now(), f = o - t, g = m(a.mdDiameter), b = g - u(g), v = r || n.easeFn, E = d || n.duration;
                ...
                o(d), d.toggleClass(v, c.hasOwnProperty("disabled")), a.mdMode === b && C(), a.$on("$destroy", function () {
                    ...
                    if (o !== i && d.toggleClass(v, !!o), o)y(); else if (n !== g && n !== b && (n = b, c.$set("mdMode", n)), n === b)C(); else {
                        var r = l(e[0]);
            ...
            var p = e.requestAnimationFrame || t.noop, h = e.cancelAnimationFrame || t.noop, f = e.Math.PI / 180, g = "determinate", b = "indeterminate", v = "_md-progress-circular-disabled", E = "md-mode-indeterminate";
            return {
                restrict: "E",
        ...
        function e() {
            function e(e, o, i, r) {
                if (r) {
                    var a = r.getTabElementIndex(o), d = n(o, "md-tab-body").remove(), s = n(o, "md-tab-label").remove(), c = r.insertTab({
                        scope: e,
                        parent: e.$parent,
                        index: a,
                        element: o,
        ...
        function e(e, o, i, r, a, d, s, c, l, m) {
            ...
            function p() {
                var e = c.$mdTabsTemplate, n = t.element(o[0].querySelector("md-tab-data"));
            ...
            function T(n) {
                var o = F(), i = le.shouldCenterTabs ? "" : "-" + n + "px";
            ...
            function L(e) {
                if (!he) {
                    var t = le.selectedIndex, n = le.tabs.splice(e.getIndex(), 1)[0];
            ...
            function Z() {
                var e = le.tabs[le.selectedIndex], t = le.tabs[le.focusIndex];
            ...
            function re() {
                ...
                var e = F(), t = e.contents[le.selectedIndex], i = t ? t.offsetHeight : 0, r = e.wrapper.offsetHeight, a = i + r, c = o.prop("clientHeight");
                if (c !== a) {
                    "bottom" === o.attr("md-align-tabs") && (c -= r, a -= r, o.attr("md-border-bottom") !== n && ++c), me = !0;
                    var l = {height: c + "px"}, m = {height: a + "px"};
                    o.css(l), s(o, {
                        from: l,
                        to: m,
            ...
            function ae() {
                var e = F();
                if (!e.tabs[le.selectedIndex])return void t.element(e.inkBar).css({left: "auto", right: "auto"});
                if (!le.tabs.length)return pe.push(le.updateInkBarStyles);
                if (!o.prop("offsetParent"))return _();
                var n = le.selectedIndex, i = e.paging.offsetWidth, r = e.tabs[n], a = r.offsetLeft, s = i - a - r.offsetWidth;
            ...
            function de() {
                var e = F(), n = le.selectedIndex, o = le.lastSelectedIndex, i = t.element(e.inkBar);
            ...
            var le = this, me = !1, ue = F(), pe = [], he = !1, fe = !1;
            ...
            return {
                require: "^?mdTabs", link: function (e, t, n, o) {
                    if (o) {
                        ...
                        }), r = {childList: !0, subtree: !0, characterData: !0};
