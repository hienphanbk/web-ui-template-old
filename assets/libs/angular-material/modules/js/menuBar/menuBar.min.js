...
!function (e, t, n) {
    "use strict";
    function o(e, n, o, i, r, s, u, l) {
        this.$element = o, this.$attrs = i, this.$mdConstant = r, this.$mdUtil = u, this.$document = s, this.$scope = e, this.$rootScope = n, this.$timeout = l;
        var d = this;
    ...
    function u(e) {
        return {
            ...
            compile: function (n, o) {
                ...
                var s = o.type, u = "md-in-menu-bar";
                if ("checkbox" != s && "radio" != s || !n.hasClass(u))i("role", "menuitem", n[0].querySelector("md-button, button, a")); else {
                    var a = n[0].textContent, l = t.element('<md-button type="button"></md-button>');
                    l.html(a), l.attr("tabindex", "0"), n.html(""), n.append(t.element('<md-icon md-svg-icon="check"></md-icon>')), n.append(l), n.addClass("md-indent").removeClass(u), i("role", "checkbox" == s ? "menuitemcheckbox" : "menuitemradio", l), r("ng-disabled")
                }
    ...
    t.module("material.components.menuBar", ["material.core", "material.components.menu"]), t.module("material.components.menuBar").controller("MenuBarController", o);
    var a = ["handleKeyDown", "handleMenuHover", "scheduleOpenHoveredMenu", "cancelScheduledOpen"];
    o.$inject = ["$scope", "$rootScope", "$element", "$attrs", "$mdConstant", "$document", "$mdUtil", "$timeout"], o.prototype.init = function () {
        ...
        })), r.push(this.$rootScope.$on("$mdMenuClose", function (o, r, s) {
            var u = i.getMenus();
            if (u.indexOf(r[0]) != -1 && (e[0].classList.remove("md-open"), r[0].classList.remove("md-open")), e[0].contains(r[0])) {
                for (var a = r[0]; a && u.indexOf(a) == -1;)a = t.getClosest(a, "MD-MENU", !0);
                a && (s.skipFocus || a.querySelector("button:not([disabled])").focus(), i.currentlyOpenMenu = n, i.disableOpenOnHover(), i.setKeyboardMode(!0))
            }
        ...
        switch (e.keyCode) {
            ...
            case n.UP_ARROW:
                ...
                break;
            case n.LEFT_ARROW:
                s = this.focusMenu(-1), i && (u = t.element(s).controller("mdMenu"), this.scheduleOpenMenu(u)), r = !0;
                break;
            case n.RIGHT_ARROW:
                s = this.focusMenu(1), i && (u = t.element(s).controller("mdMenu"), this.scheduleOpenMenu(u)), r = !0
        }
        ...
        return -1
    }, t.module("material.components.menuBar").directive("mdMenuBar", i), i.$inject = ["$mdUtil", "$mdTheming"], t.module("material.components.menuBar").directive("mdMenuDivider", r), t.module("material.components.menuBar").controller("MenuItemController", s), s.$inject = ["$scope", "$element", "$attrs"], s.prototype.init = function (e) {
        ...
        function e() {
            if ("radio" == u) {
                var e = s.ngValue ? r.$eval(s.ngValue) : s.value;
        ...
        var o = this, i = this.ngModel, r = this.$scope, s = this.$attrs, u = (this.$element, this.mode);
        this.handleClick = t.bind(this, this.handleClick);
        var a = this.iconEl, l = t.element(this.buttonEl), d = this.handleClick;
        s.$observe("disabled", n), n(s.disabled), i.$render = function () {
            o.clearNgAria(), e() ? (a.style.display = "", l.attr("aria-checked", "true")) : (a.style.display = "none", l.attr("aria-checked", "false"))
    ...
    }, t.module("material.components.menuBar").directive("mdMenuItem", u), u.$inject = ["$mdUtil"]
