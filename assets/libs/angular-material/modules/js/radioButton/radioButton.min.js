...
!function (e, t, n) {
    ...
    function i(e, n, i, r) {
        function o(o, d, a, s) {
            ...
            function c(i) {
                ...
                if (r == n.KEY_CODE.ENTER || i.currentTarget == i.target)switch (r) {
                    case n.KEY_CODE.LEFT_ARROW:
                    case n.KEY_CODE.UP_ARROW:
                        i.preventDefault(), l.selectPrevious(), u();
                        break;
                    case n.KEY_CODE.RIGHT_ARROW:
                    case n.KEY_CODE.DOWN_ARROW:
                        i.preventDefault(), l.selectNext(), u();
                        break;
            ...
            d.addClass("_md"), i(d);
            var l = s[0], m = s[1] || e.fakeNgModel();
            l.init(m), o.mouseActive = !1, d.attr({
                role: "radiogroup",
                tabIndex: d.attr("tabindex") || "0"
        ...
        function s(n, i) {
            ...
            if (r.count()) {
                ...
                }, d = n[0].querySelector("md-radio-button.md-checked"), a = r[i < 0 ? "previous" : "next"](d, o) || r.first();
    ...
    function r(e, t, n) {
        function i(i, o, d, a) {
            function s() {
                if (!a)throw"RadioButton: No RadioGroupController could be found.";
                a.add(c), d.$observe("value", c), o.on("click", u).on("$destroy", function () {
                    a.remove(c)
                })
            }
            ...
            function c() {
                ...
                var t = a.getViewValue() == d.value;
                t !== m && (m = t, o.attr("aria-checked", t), t ? (e(!0), o.addClass(r), a.setActiveDescendant(o.attr("id"))) : (e(!1), o.removeClass(r)))
            }
    ...
    t.module("material.components.radioButton", ["material.core"]).directive("mdRadioGroup", i).directive("mdRadioButton", r), i.$inject = ["$mdUtil", "$mdConstant", "$mdTheming", "$timeout"], r.$inject = ["$mdAria", "$mdUtil", "$mdTheming"]
