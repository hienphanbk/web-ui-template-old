...
function MdNavBar(t) {
    return {
        ...
        link: function (e, n, a, r) {
            r.navBarAriaLabel || t.expectAsync(n, "aria-label", angular.noop)
        }
    }
}
function MdNavBarController(t, e, n, a) {
...
function MdNavItem(t) {
    return {
        ...
        link: function (e, n, a, r) {
            var o = r[0], l = r[1];
            t(function () {
                o.name || (o.name = angular.element(n[0].querySelector("._md-nav-button-text")).text().trim());
                var t = angular.element(n[0].querySelector("._md-nav-button"));
                t.on("click", function () {
                    l.mdSelectedNavItem = o.name, e.$apply()
                })
            })
        }
    }
...
goog.provide("ngmaterial.components.navBar"), goog.require("ngmaterial.core"), angular.module("material.components.navBar", ["material.core"]).controller("MdNavBarController", MdNavBarController).directive("mdNavBar", MdNavBar).controller("MdNavItemController", MdNavItemController).directive("mdNavItem", MdNavItem), MdNavBar.$inject = ["$mdAria"], MdNavBarController.$inject = ["$element", "$scope", "$timeout", "$mdConstant"], MdNavBarController.prototype._initTabs = function () {
    ...
    var n = this, a = this._getTabs(), r = -1, o = -1, l = this._getTabByName(t), i = this._getTabByName(e);
    i && (i.setSelected(!1), r = a.indexOf(i)), l && (l.setSelected(!0), o = a.indexOf(l)), this._$timeout(function () {
        n._updateInkBarStyles(l, o, r)
    })
}, MdNavBarController.prototype._updateInkBarStyles = function (t, e, n) {
...
}, MdNavItem.$inject = ["$$rAF"], MdNavItemController.$inject = ["$element"], MdNavItemController.prototype.getNgClassMap = function () {
    return {
