...
function mdRadioGroupDirective(e, t, n, i) {
    function r(r, o, a, d) {
        ...
        function c(n) {
            ...
            if (i == t.KEY_CODE.ENTER || n.currentTarget == n.target)switch (i) {
                case t.KEY_CODE.LEFT_ARROW:
                case t.KEY_CODE.UP_ARROW:
                    n.preventDefault(), s.selectPrevious(), u();
                    break;
                case t.KEY_CODE.RIGHT_ARROW:
                case t.KEY_CODE.DOWN_ARROW:
                    n.preventDefault(), s.selectNext(), u();
                    break;
        ...
        o.addClass("_md"), n(o);
        var s = d[0], l = d[1] || e.fakeNgModel();
        s.init(l), r.mouseActive = !1, o.attr({
            role: "radiogroup",
            ...
            r.mouseActive === !1 && s.$element.addClass("md-focused")
        }).on("blur", function () {
    ...
    function d(t, n) {
        var i = e.iterator(t[0].querySelectorAll("md-radio-button"), !0);
        if (i.count()) {
            var r = function (e) {
                return !angular.element(e).attr("disabled")
            }, o = t[0].querySelector("md-radio-button.md-checked"), a = i[n < 0 ? "previous" : "next"](o, r) || i.first();
...
function mdRadioButtonDirective(e, t, n) {
    function i(i, o, a, d) {
        function u() {
            ...
            d.add(s), a.$observe("value", s), o.on("click", c).on("$destroy", function () {
                d.remove(s)
            })
        }

        function c(e) {
            o[0].hasAttribute("disabled") || d.isDisabled() || i.$apply(function () {
        ...
        function s() {
            function e(e) {
                "MD-RADIO-GROUP" != o.parent()[0].nodeName && o.parent()[e ? "addClass" : "removeClass"](r)
            }

            var t = d.getViewValue() == a.value;
            t !== m && (m = t, o.attr("aria-checked", t), t ? (e(!0), o.addClass(r), d.setActiveDescendant(o.attr("id"))) : (e(!1), o.removeClass(r)))
        }
...
goog.provide("ngmaterial.components.radioButton"), goog.require("ngmaterial.core"), angular.module("material.components.radioButton", ["material.core"]).directive("mdRadioGroup", mdRadioGroupDirective).directive("mdRadioButton", mdRadioButtonDirective), mdRadioGroupDirective.$inject = ["$mdUtil", "$mdConstant", "$mdTheming", "$timeout"], mdRadioButtonDirective.$inject = ["$mdAria", "$mdUtil", "$mdTheming"], ngmaterial.components.radioButton = angular.module("material.components.radioButton");