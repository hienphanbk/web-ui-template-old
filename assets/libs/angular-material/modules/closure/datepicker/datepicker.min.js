...
goog.provide("ngmaterial.components.datepicker"), goog.require("ngmaterial.components.icon"), goog.require("ngmaterial.components.virtualRepeat"), goog.require("ngmaterial.core"), angular.module("material.components.datepicker", ["material.core", "material.components.icon", "material.components.virtualRepeat"]), function () {
    ...
    function e() {
        return {
            template: function (e, t) {
                var a = t.hasOwnProperty("ngIf") ? "" : 'ng-if="calendarCtrl.isInitialized"', n = '<div ng-switch="calendarCtrl.currentView" ' + a + '><md-calendar-year ng-switch-when="year"></md-calendar-year><md-calendar-month ng-switch-default></md-calendar-month></div>';
                return n
            },
            scope: {
                minDate: "=mdMinDate",
    ...
    function t(e, t, a, i, r, l, s, d) {
        l(e), this.$element = e, this.$scope = t, this.dateUtil = a, this.$mdUtil = i, this.keyCode = r.KEY_CODE, this.$$rAF = s, this.today = this.dateUtil.createDateAtMidnight(), this.ngModelCtrl = null, this.currentView = this._currentView || "month", this.SELECTED_DATE_CLASS = "md-calendar-selected-date", this.TODAY_CLASS = "md-calendar-date-today", this.FOCUSED_DATE_CLASS = "md-focus", this.id = n++, this.displayDate = null, this.selectedDate = null, this.isInitialized = !1, this.width = 0, this.scrollbarWidth = 0, d.tabindex || e.attr("tabindex", "-1"), e.on("keydown", angular.bind(this, this.handleKeyEvent))
    }

    angular.module("material.components.datepicker").directive("mdCalendar", e);
    var a = 340, n = 0;
    t.$inject = ["$element", "$scope", "$$mdDateUtil", "$mdUtil", "$mdConstant", "$mdTheming", "$$rAF", "$attrs"], t.prototype.configureNgModel = function (e) {
        var t = this;
        ...
        if (this.dateUtil.isValidDate(e)) {
            ...
            var a = this.getDateId(e, this.currentView), n = document.getElementById(a);
            n && (n.classList.add(this.FOCUSED_DATE_CLASS), n.focus(), this.displayDate = e)
        } else {
        ...
        this.$scope.$apply(function () {
            ...
            var a = t.getActionFromKeyEvent(e);
            a && (e.preventDefault(), e.stopPropagation(), t.$scope.$broadcast("md-calendar-parent-action", a))
        })
    }, t.prototype.hideVerticalScrollbar = function (e) {
        function t() {
            var t = n.width || a, i = n.scrollbarWidth, l = e.calendarScroller;
            r.style.width = t + "px", l.style.width = t + i + "px", l.style.paddingRight = i + "px"
        }

        var n = this, i = e.$element[0], r = i.querySelector(".md-calendar-scroll-mask");
        n.width > 0 ? t() : n.$$rAF(function () {
            var a = e.calendarScroller;
            n.scrollbarWidth = a.offsetWidth - a.clientWidth, n.width = i.querySelector("table").offsetWidth, t()
        })
    ...
    function e() {
        return {
            template: '<table aria-hidden="true" class="md-calendar-day-header"><thead></thead></table><div class="md-calendar-scroll-mask"><md-virtual-repeat-container class="md-calendar-scroll-container" md-offset-size="' + (n - a) + '"><table role="grid" tabindex="0" class="md-calendar" aria-readonly="true"><tbody md-calendar-month-body role="rowgroup" md-virtual-repeat="i in monthCtrl.items" md-month-offset="$index" class="md-calendar-month" md-start-index="monthCtrl.getSelectedMonthIndex()" md-item-size="' + a + '"></tbody></table></md-virtual-repeat-container></div>',
    ...
    function t(e, t, a, n, i, r) {
        this.$element = e, this.$scope = t, this.$animate = a, this.$q = n, this.dateUtil = i, this.dateLocale = r, this.calendarScroller = e[0].querySelector(".md-virtual-repeat-scroller"), this.firstRenderableDate = null, this.isInitialized = !1, this.isMonthTransitionInProgress = !1;
        var l = this;
    ...
    angular.module("material.components.datepicker").directive("mdCalendarMonth", e);
    var a = 265, n = 45;
    t.$inject = ["$element", "$scope", "$animate", "$q", "$$mdDateUtil", "$mdDateLocale"], t.prototype.initialize = function (e) {
        var t = e.minDate, a = e.maxDate;
        if (this.calendarCtrl = e, this.items = {length: 2e3}, a && t) {
            var n = this.dateUtil.getMonthDistance(t, a) + 1;
            n = Math.max(n, 1), n += 1, this.items.length = n
        }
        if (this.firstRenderableDate = this.dateUtil.incrementMonths(e.today, -this.items.length / 2), t && t > this.firstRenderableDate)this.firstRenderableDate = t; else if (a) {
            this.items.length - 2;
        ...
        var t = this, a = t.calendarCtrl, n = a.selectedDate;
        a.selectedDate = e, this.changeDisplayDate(e).then(function () {
            var t = a.SELECTED_DATE_CLASS, i = "month";
            if (n) {
                var r = document.getElementById(a.getDateId(n, i));
                r && (r.classList.remove(t), r.setAttribute("aria-selected", "false"))
            }
            if (e) {
                var l = document.getElementById(a.getDateId(e, i));
                l && (l.classList.add(t), l.setAttribute("aria-selected", "true"))
            }
        })
        ...
        if (this.dateUtil.isValidDate(e)) {
            ...
            this.calendarScroller.scrollTop = t * a
        }
        return this.$q.when()
        ...
        for (var e = this.dateLocale.firstDayOfWeek, t = this.dateLocale.shortDays, a = document.createElement("tr"), n = 0; n < 7; n++) {
            ...
            i.textContent = t[(n + e) % 7], a.appendChild(i)
        }
        this.$element.find("thead").append(a)
    }, t.prototype.attachScopeListeners = function () {
        var e = this;
        e.$scope.$on("md-calendar-parent-changed", function (t, a) {
        ...
        if ("select" === t)a.setNgModelValue(n); else {
    ...
    "use strict";
    function e(e, a) {
        var n = e('<md-icon md-svg-src="' + a.mdTabsArrow + '"></md-icon>')({})[0];
        return {
            ...
            link: function (e, t, a, i) {
                ...
                s.calendarCtrl = r, s.monthCtrl = l, s.arrowIcon = n.cloneNode(!0), s.generateContent(), e.$watch(function () {
                    return s.offset
                }, function (e, t) {
                    e !== t && s.generateContent()
                })
            }
        }
    }
    ...
    angular.module("material.components.datepicker").directive("mdCalendarMonthBody", e), e.$inject = ["$compile", "$$mdSvgRegistry"], t.$inject = ["$element", "$$mdDateUtil", "$mdDateLocale"], t.prototype.generateContent = function () {
        ...
        var t = this.monthCtrl, a = this.calendarCtrl, n = document.createElement("td");
        if (n.tabIndex = -1, n.classList.add("md-calendar-date"), n.setAttribute("role", "gridcell"), e) {
            ...
            if (this.isDateEnabled(e)) {
                ...
                r.classList.add("md-calendar-date-selection-indicator"), r.textContent = i, n.appendChild(r), n.addEventListener("click", t.cellClickHandler), a.displayDate && this.dateUtil.isSameDay(e, a.displayDate) && (this.focusAfterAppend = n)
    ...
    function e() {
        return {
            template: '<div class="md-calendar-scroll-mask"><md-virtual-repeat-container class="md-calendar-scroll-container"><table role="grid" tabindex="0" class="md-calendar" aria-readonly="true"><tbody md-calendar-year-body role="rowgroup" md-virtual-repeat="i in yearCtrl.items" md-year-offset="$index" class="md-calendar-year" md-start-index="yearCtrl.getFocusedYearIndex()" md-item-size="' + a + '"></tbody></table></md-virtual-repeat-container></div>',
    ...
    function t(e, t, a, n, i) {
        this.$element = e, this.$scope = t, this.$animate = a, this.$q = n, this.dateUtil = i, this.calendarScroller = e[0].querySelector(".md-virtual-repeat-scroller"), this.firstRenderableDate = null, this.isInitialized = !1, this.isMonthTransitionInProgress = !1;
        var r = this;
        this.cellClickHandler = function () {
    ...
    angular.module("material.components.datepicker").directive("mdCalendarYear", e);
    var a = 88;
    t.$inject = ["$element", "$scope", "$animate", "$q", "$$mdDateUtil"], t.prototype.initialize = function (e) {
        var t = e.minDate, a = e.maxDate;
        if (this.calendarCtrl = e, this.items = {length: 400}, this.firstRenderableDate = this.dateUtil.incrementYears(e.today, -(this.items.length / 2)), t && t > this.firstRenderableDate ? this.firstRenderableDate = t : a && (this.firstRenderableDate = this.dateUtil.incrementMonths(a, -(this.items.length - 1))), a && t) {
        ...
        if (this.dateUtil.isValidDate(e) && !this.isMonthTransitionInProgress) {
            var t = this, a = this.animateDateChange(e);
            return t.isMonthTransitionInProgress = !0, t.calendarCtrl.displayDate = e, a.then(function () {
        ...
        var a = this.calendarCtrl, n = a.displayDate;
        if ("select" === t)this.changeDate(n).then(function () {
    ...
    function e() {
        return {
            ...
            link: function (e, t, a, n) {
                ...
                l.calendarCtrl = i, l.yearCtrl = r, l.generateContent(), e.$watch(function () {
                    return l.offset
                }, function (e, t) {
                    e != t && l.generateContent()
                })
            }
        }
    }
    ...
    angular.module("material.components.datepicker").directive("mdCalendarYearBody", e), t.$inject = ["$element", "$$mdDateUtil", "$mdDateLocale"], t.prototype.generateContent = function () {
        ...
        var a = this.calendarCtrl, n = this.yearCtrl, i = this.buildBlankCell(), r = new Date(e, t, 1);
        ...
        var l = this.dateLocale.shortMonths[t];
        ...
        var t, a = e.getFullYear(), n = document.createDocumentFragment(), i = document.createElement("tr"), r = document.createElement("td");
        for (r.className = "md-calendar-month-label", r.textContent = a, i.appendChild(r), t = 0; t < 6; t++)i.appendChild(this.buildMonthCell(a, t));
        n.appendChild(i);
        var l = document.createElement("tr");
        for (l.appendChild(this.buildBlankCell()), t = 6; t < 12; t++)l.appendChild(this.buildMonthCell(a, t));
    ...
    angular.module("material.components.datepicker").config(["$provide", function (e) {
        ...
        t.prototype.$get = function (e, t) {
            function a(e) {
                if (!e)return "";
                var a = e.toLocaleTimeString(), n = e;
                return 0 != e.getHours() || a.indexOf("11:") === -1 && a.indexOf("23:") === -1 || (n = new Date(e.getFullYear(), e.getMonth(), e.getDate(), 1, 0, 0)), t("date")(n, "M/d/yyyy")
            }
            ...
            function r(e) {
                return p.shortMonths[e.getMonth()] + " " + e.getFullYear()
            }

            function l(e) {
                return p.months[e.getMonth()] + " " + e.getFullYear()
            }
            ...
            function d(e) {
                return [p.days[e.getDay()], p.months[e.getMonth()], p.dates[e.getDate()], e.getFullYear()].join(" ")
            }
    ...
    angular.module("material.components.datepicker").factory("$$mdDateUtil", function () {
        ...
        function o(t) {
            var a = e(t);
            return Math.floor((a.getDay() + t.getDate() - 1) / 7)
        }
        ...
        function h(e, a) {
            var n = new Date(e.getFullYear(), e.getMonth() + a, 1), i = t(n);
            return i < e.getDate() ? n.setDate(i) : n.setDate(e.getDate()), n
        }
        ...
        function g(e) {
            var t;
            return t = angular.isUndefined(e) ? new Date : new Date(e), f(t), t
        }

        function D(e, t, a) {
            var n = g(e), i = p(t) ? g(t) : null, r = p(a) ? g(a) : null;
            return (!i || i <= n) && (!r || r >= n)
        }
        ...
        function y(e, t, a) {
            var n = e;
            return t && e < t && (n = new Date(t.getTime())), a && e > a && (n = new Date(a.getTime())), n
        }
        ...
        function b(e, t, a) {
            ...
            return (!t || t.getFullYear() < i || t.getMonth() <= n) && (!a || a.getFullYear() > i || a.getMonth() >= n)
        }

        return {
            getFirstDateOfMonth: e,
            getNumberOfDaysInMonth: t,
            getDateInNextMonth: a,
            getDateInPreviousMonth: n,
            isInNextMonth: l,
            isInPreviousMonth: s,
            getDateMidpoint: d,
    ...
    function e(e, a, n) {
        return {
            ...
            link: function (e, t, i, s) {
                var d = s[0], o = s[1], c = s[2], h = s[3], u = a.parseAttributeBoolean(i.mdNoAsterisk);
                if (o.configureNgModel(d, c), c) {
                    var m = t[0].querySelector(".md-errors-spacer");
                    m && t.after(angular.element("<div>").append(m)), c.setHasPlaceholder(i.mdPlaceholder), c.input = t, c.element.addClass(r).toggleClass(l, "calendar" !== i.mdHideIcons && "all" !== i.mdHideIcons), c.label ? u || i.$observe("required", function (e) {
                        c.label.toggleClass("md-required", !!e)
                    }) : n.expect(t, "aria-label", i.mdPlaceholder), e.$watch(c.isErrorGetter || function () {
                            return d.$invalid && (d.$touched || h && h.$submitted)
                        }, c.setInvalid)
                } else if (h)var p = e.$watch(function () {
                    return h.$submitted
                }, function (e) {
                    e && (o.updateErrorState(), p())
                })
            }
        }
    }
    ...
    angular.module("material.components.datepicker").directive("mdDatepicker", e), e.$inject = ["$$mdSvgRegistry", "$mdUtil", "$mdAria"];
    var a = 3, n = "md-datepicker-invalid", i = "md-datepicker-open", r = "_md-datepicker-floating-label", l = "_md-datepicker-has-calendar-icon", s = 500, d = 368, o = 360;
    t.$inject = ["$scope", "$element", "$attrs", "$window", "$mdConstant", "$mdTheming", "$mdUtil", "$mdDateLocale", "$$mdDateUtil", "$$rAF", "$mdGesture"], t.prototype.configureNgModel = function (e, t) {
        this.ngModelCtrl = e, this.mdInputContainer = t;
        var a = this;
        e.$render = function () {
            var e = a.ngModelCtrl.$viewValue;
            ...
            a.date = e, a.inputElement.value = a.dateLocale.formatDate(e), a.mdInputContainer && a.mdInputContainer.setHasValue(!!e), a.resizeInputElement(), a.updateErrorState()
        }, e.$viewChangeListeners.unshift(angular.bind(this, this.updateErrorState))
    }, t.prototype.attachChangeListeners = function () {
        var e = this;
        e.$scope.$on("md-calendar-change", function (t, a) {
            e.ngModelCtrl.$setViewValue(a), e.date = a, e.inputElement.value = e.dateLocale.formatDate(a), e.mdInputContainer && e.mdInputContainer.setHasValue(!!a), e.closeCalendarPane(), e.resizeInputElement(), e.updateErrorState()
        }), e.ngInputElement.on("input", angular.bind(e, e.resizeInputElement));
        var t = angular.isDefined(this.debounceInterval) ? this.debounceInterval : s;
        e.ngInputElement.on("input", e.$mdUtil.debounce(e.handleInputEvent, t, e))
    }, t.prototype.attachInteractionListeners = function () {
        var e = this, t = this.$scope, a = this.$mdConstant.KEY_CODE;
        e.ngInputElement.on("keydown", function (n) {
        ...
        if (this.clearErrorState(), this.dateUtil.isValidDate(t)) {
            if (t = this.dateUtil.createDateAtMidnight(t), this.dateUtil.isValidDate(this.minDate)) {
                var a = this.dateUtil.createDateAtMidnight(this.minDate);
                this.ngModelCtrl.$setValidity("mindate", t >= a)
            }
        ...
        this.ngModelCtrl.$valid || this.inputContainer.classList.add(n)
        ...
        var a = "" == e || this.dateUtil.isValidDate(t) && this.dateLocale.isDateComplete(e) && this.isDateEnabled(t);
        a && (this.ngModelCtrl.$setViewValue(t), this.date = t), this.updateErrorState(t)
    }, t.prototype.isDateEnabled = function (e) {
        ...
        var e = this.calendarPane, t = document.body;
        e.style.transform = "", this.$element.addClass(i), this.mdInputContainer && this.mdInputContainer.element.addClass(i), angular.element(t).addClass("md-datepicker-is-showing");
        var a = this.inputContainer.getBoundingClientRect(), n = t.getBoundingClientRect(), r = a.top - n.top, l = a.left - n.left, s = n.top < 0 && 0 == document.body.scrollTop ? -n.top : document.body.scrollTop, c = n.left < 0 && 0 == document.body.scrollLeft ? -n.left : document.body.scrollLeft, h = s + this.$window.innerHeight, u = c + this.$window.innerWidth;
        if (l + o > u) {
            if (u - o > 0)l = u - o; else {
                l = c;
                var m = this.$window.innerWidth / o;
                e.style.transform = "scale(" + m + ")"
            }
            e.classList.add("md-datepicker-pos-adjusted")
        }
        r + d > h && h - d > s && (r = h - d, e.classList.add("md-datepicker-pos-adjusted")), e.style.left = l + "px", e.style.top = r + "px", document.body.appendChild(e), this.inputMask.style.left = a.width + "px", this.$$rAF(function () {
        ...
        if (this.isCalendarOpen) {
            var t = this;
            t.detachCalendarPane(), t.ngModelCtrl.$setTouched(), t.evalAttr("ngBlur"), t.documentElement.off("click touchstart", t.bodyClickHandler), window.removeEventListener(t.windowEventName, t.windowEventHandler), t.calendarPaneOpenedFrom.focus(), t.calendarPaneOpenedFrom = null, t.openOnFocus ? t.$mdUtil.nextTick(e) : e()
        }
