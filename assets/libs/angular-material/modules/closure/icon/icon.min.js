    ...
    function o(i, o, a) {
        ...
        function c() {
            if (!a.mdSvgIcon && !a.mdSvgSrc) {
                a.mdFontIcon && (o.removeClass(g), o.addClass(a.mdFontIcon), g = a.mdFontIcon);
                var t = e.fontSet(a.mdFontSet);
                I !== t && (o.removeClass(I), o.addClass(t), I = t)
            }
        }

        t(o);
        var g = a.mdFontIcon, I = e.fontSet(a.mdFontSet);
        u(), a.$observe("mdFontIcon", c), a.$observe("mdFontSet", c);
        var d = (o[0].getAttribute(a.$attr.mdSvgSrc), a.alt || a.mdFontIcon || a.mdSvgIcon || o.text()), l = a.$normalize(a.$attr.mdSvgIcon || a.$attr.mdSvgSrc || "");
        a["aria-label"] || ("" === d || r() ? o.text() || n.expect(o, "aria-hidden", "true") : (n.expect(o, "aria-label", d), n.expect(o, "role", "img"))), l && a.$observe(l, function (t) {
...
function MdIconService(e, t, n, i, o, a) {
    function r(t) {
        if (t = t || "", angular.isString(t) || (t = a.getTrustedUrl(t)), M[t])return n.when(c(M[t]));
        if (v.test(t) || j.test(t))return l(t).then(g(t));
    ...
    function u(t) {
        var n = angular.isUndefined(t) || !(t && t.length);
        if (n)return e.defaultFontSet;
        var i = t;
        return angular.forEach(e.fontSets, function (e) {
            e.alias == t && (i = e.fontSet || i)
        }), i
    }

    function c(e) {
        var t = e.clone(), n = "_cache" + o.nextUid();
        return t.id && (t.id += n), angular.forEach(t.querySelectorAll("[id]"), function (e) {
            e.id += n
        }), t
    }
    ...
    function I(t) {
        var n = e[t];
        return l(n.url).then(function (e) {
            return new s(e, n)
        })
    }
    ...
    function d(t) {
        function o(e) {
            var n = t.slice(t.lastIndexOf(":") + 1), i = e.querySelector("#" + n);
            return i ? new s(i, u) : a(t)
        }

        function a(e) {
            var t = "icon " + e + " not found";
            return i.warn(t), n.reject(t || e)
        }

        var r = t.substring(0, t.lastIndexOf(":")) || "$default", u = e[r];
        return u ? l(u.url).then(o) : a(t)
    }

    function l(e) {
        function o(e) {
            var t = j.exec(e), i = /base64/i.test(e), o = i ? window.atob(t[2]) : t[2];
            return n.when(angular.element(o)[0])
        }
    ...
    function f() {
        var t = this.config ? this.config.viewBoxSize : e.defaultViewBoxSize;
        angular.forEach({
            fit: "",
            height: "100%",
            width: "100%",
    ...
    var M = {}, x = {}, v = /[-\w@:%\+.~#?&\/\/=]{2,}\.[a-z]{2,4}\b(\/[-\w@:%\+.~#?&\/\/=]*)?/i, j = /^data:image\/svg\+xml[\s*;\w\-\=]*?(base64)?,(.*)$/i;
    return s.prototype = {clone: S, prepare: f}, r.fontSet = u, r
}
goog.provide("ngmaterial.components.icon"), goog.require("ngmaterial.core"), angular.module("material.components.icon", ["material.core"]), angular.module("material.components.icon").directive("mdIcon", ["$mdIcon", "$mdTheming", "$mdAria", "$sce", mdIconDirective]), angular.module("material.components.icon").constant("$$mdSvgRegistry", {
...
MdIconProvider.prototype = {
    icon: function (e, t, n) {
        ...
        var n = "$default";
        return config[n] || (config[n] = new ConfigurationItem(e, t)), config[n].viewBoxSize = t || config.defaultViewBoxSize, this
...
}, MdIconService.$inject = ["config", "$templateRequest", "$q", "$log", "$mdUtil", "$sce"], ngmaterial.components.icon = angular.module("material.components.icon");