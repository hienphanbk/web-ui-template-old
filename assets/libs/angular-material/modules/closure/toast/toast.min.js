...
function MdToastProvider(t) {
    ...
    function n(t, e, n, a) {
        function s(s, i, l) {
            o = l.textContent || l.content;
            var m = !a("gt-sm");
            return i = n.extractElementByName(i, "md-toast", !0), l.element = i, l.onSwipe = function (t, o) {
                var a = t.type.replace("$md.", ""), s = a.replace("swipe", "");
                "down" === s && l.position.indexOf("top") != -1 && !m || "up" === s && (l.position.indexOf("bottom") != -1 || m) || ("left" !== s && "right" !== s || !m) && (i.addClass("md-" + a), n.nextTick(e.cancel))
        ...
        return {
            ...
            hideDelay: 3e3,
            autoWrap: !0,
            transformTemplate: function (t, e) {
                var n = e.autoWrap && t && !/md-toast-content/g.test(t);
                if (n) {
                    var o = document.createElement("md-template");
                    o.innerHTML = t;
                    for (var a = 0; a < o.children.length; a++)if ("MD-TOAST" === o.children[a].nodeName) {
                        var s = angular.element('<div class="md-toast-content">');
                        s.append(angular.element(o.children[a].childNodes)), o.children[a].appendChild(s[0])
                    }
                    return o.innerHTML
                }
                return t || ""
    ...
    var o, a = "ok", s = t("$mdToast").setDefaults({
        ...
        options: ["$mdToast", "$mdTheming", function (t, e) {
            return {
                ...
                controller: ["$scope", function (e) {
                    var n = this;
                    n.highlightAction && (e.highlightClasses = ["md-highlight", n.highlightClass]), e.$watch(function () {
                        return o
                    }, function () {
                        n.content = o
    ...
    }).addMethod("updateTextContent", e).addMethod("updateContent", e);
    return n.$inject = ["$animate", "$mdToast", "$mdUtil", "$mdMedia"], s
}
goog.provide("ngmaterial.components.toast"), goog.require("ngmaterial.components.button"), goog.require("ngmaterial.core"), angular.module("material.components.toast", ["material.core", "material.components.button"]).directive("mdToast", MdToastDirective).provider("$mdToast", MdToastProvider), MdToastDirective.$inject = ["$mdToast"], MdToastProvider.$inject = ["$$interimElementProvider"], ngmaterial.components.toast = angular.module("material.components.toast");